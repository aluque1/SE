...
int main() 
{
...

   {
      ...
      print("\r\nRunning GpioOutputExample() for xps_gpio_LEDS...\r\n");

      status = GpioOutputExample(XPAR_XPS_GPIO_LEDS_DEVICE_ID,8);
...

   {
      ...
      print("\r\nRunning GpioOutputExample() for xps_gpio_SW...\r\n");

      status = GpioOutputExample(XPAR_XPS_GPIO_SW_DEVICE_ID,8);
