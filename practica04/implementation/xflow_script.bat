...
@REM #
ngdbuild -p xc3s1000ft256-5 -nt timestamp -bm practica04.bmm "C:/Users/aluqu/Desktop/uni/SE/practica04/implementation/practica04.ngc" -uc practica04.ucf practica04.ngd 
