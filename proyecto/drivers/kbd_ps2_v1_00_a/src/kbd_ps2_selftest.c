/*****************************************************************************
* Filename:          C:\Users\aluqu\Desktop\uni\SE\proyecto/drivers/kbd_ps2_v1_00_a/src/kbd_ps2_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the kbd_ps2 driver
...
XStatus KBD_PS2_SelfTest(void * baseaddr_p)
{
  ...
  KBD_PS2_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = KBD_PS2_mReadSlaveReg0(baseaddr, 0);
