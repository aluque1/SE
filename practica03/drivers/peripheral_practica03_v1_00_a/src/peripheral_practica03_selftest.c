/*****************************************************************************
* Filename:          C:\Users\aluqu\Desktop\uni\SE\practica03/drivers/peripheral_practica03_v1_00_a/src/peripheral_practica03_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the peripheral_practica03 driver
...
XStatus PERIPHERAL_PRACTICA03_SelfTest(void * baseaddr_p)
{
  ...
  PERIPHERAL_PRACTICA03_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = PERIPHERAL_PRACTICA03_mReadSlaveReg0(baseaddr, 0);
  ...
  PERIPHERAL_PRACTICA03_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = PERIPHERAL_PRACTICA03_mReadSlaveReg1(baseaddr, 0);
  ...
  PERIPHERAL_PRACTICA03_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = PERIPHERAL_PRACTICA03_mReadSlaveReg2(baseaddr, 0);
  ...
  PERIPHERAL_PRACTICA03_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = PERIPHERAL_PRACTICA03_mReadSlaveReg3(baseaddr, 0);
